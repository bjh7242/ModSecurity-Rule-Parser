...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','start.py',53),
  ('statement -> expression','statement',1,'p_statement_expr','start.py',57),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','start.py',61),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','start.py',62),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','start.py',63),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','start.py',64),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','start.py',71),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','start.py',75),
  ('expression -> NUMBER','expression',1,'p_expression_number','start.py',79),
  ('expression -> NAME','expression',1,'p_expression_name','start.py',83),
]
